            ...
            <div className="resumeBackground">
                <div className="resumeReady">
                    <svg id="curvi5" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 595.28 841.89">
                        ...
                        <text transform="matrix(1 0 0 1 35.1782 130.771)" fill="#16100F" fontFamily="MyriadPro-Semibold" fontSize="26.3245px">{user.name.substring(0,fullname[0])}</text>
                        <text transform="matrix(1 0 0 1 35.1782 152.771)" fill="#16100F" fontFamily="MyriadPro-Semibold" fontSize="26.3245px">{user.name.substring(fullname[0],fullname.length>0?fullname[1]:<></>)}</text>
                        <text transform="matrix(1 0 0 1 35.1782 174.771)" fill="#16100F" fontFamily="MyriadPro-Semibold" fontSize="26.3245px">{user.name.substring(fullname[1],fullname.length>1?fullname[2]:<></>)}</text>
                        <text transform="matrix(1 0 0 1 35.1782 196.771)" fill="#16100F" fontFamily="MyriadPro-Semibold" fontSize="26.3245px">{user.name.substring(fullname[2],fullname.length>2?fullname[3]:<></>)}</text>
                        <text transform="matrix(1 0 0 1 35.1782 218.771)" fill="#16100F" fontFamily="MyriadPro-Semibold" fontSize="26.3245px">{user.name.substring(fullname[3],fullname.length>3?fullname[4]:<></>)}</text>
                        ...
                        <text transform="matrix(0.9856 0 0 1 257.2417 223.1533)" fontFamily="MyriadPro-Semibold" fill="#2C242D" fontSize="15.3958px">{user.companyName !== 'Primeiro emprego objetivando adquirir conhecimento e experiência necessária junto à empresa.' ? `Empresa: ${user.companyName}` : user.companyName.substring(0, 38)}</text>
                        <text transform="matrix(0.9856 0 0 1 257.2417 243.1533)" fontFamily="MyriadPro-Semibold" fill="#2C242D" fontSize="15.3958px">{user.companyName !== 'Primeiro emprego objetivando adquirir conhecimento e experiência necessária junto à empresa.' ? `` : user.companyName.substring(38, 76)}</text>
                        <text transform="matrix(0.9856 0 0 1 257.2417 263.1533)" fontFamily="MyriadPro-Semibold" fill="#2C242D" fontSize="15.3958px">{user.companyName !== 'Primeiro emprego objetivando adquirir conhecimento e experiência necessária junto à empresa.' ? `` : user.companyName.substring(76, user.companyName.length)}</text>
                        ...
                        <text transform="matrix(1 0 0 1 257.2563 439.9448)" fontFamily="MyriadPro-Semibold" fill="#2C242D" fontSize="14px">{user.courseName}</text>
                        <text transform="matrix(1 0 0 1 257.2563 459.9448)" fontFamily="MyriadPro-Semibold" fill="#2C242D" fontSize="14px">{user.courseSchool}</text>
                        <text transform="matrix(1 0 0 1 257.2563 479.9448)" fontFamily="MyriadPro-Semibold" fill="#2C242D" fontSize="14px">{user.courseEndYear === 'Completo'?user.courseEndYear:`Previsão de Conclusão: ${user.courseEndYear}`}</text>
                        ...
                        <text transform="matrix(1 0 0 1 257.0435 636.3594)" fontFamily="MyriadPro-Semibold" fill="#2C242D" fontSize="14px">{user.courses!== 'NOT_PRINT'?user.courses.substring(0,extraCourses[3]):<></>} </text>
                        <text transform="matrix(1 0 0 1 257.0435 656.3594)" fontFamily="MyriadPro-Semibold" fill="#2C242D" fontSize="14px">{user.courses!== 'NOT_PRINT'?user.courses.substring(extraCourses[3],extraCourses.length > 3 ? extraCourses[6] : <></>):<></>}  </text>
                        ...
                        <text transform="matrix(1 0 0 1 45.4585 310.6353)" fill="#16100F" fontFamily="MyriadPro-Semibold" fontSize="12px">{user.goal.substring(0, fullgoal[3])}</text>
                        <text transform="matrix(1 0 0 1 45.4585 325.6353)" fill="#16100F" fontFamily="MyriadPro-Semibold" fontSize="12px">{user.goal.substring(fullgoal[3], fullgoal.length > 3 ? fullgoal[6] : <></>)}</text>
                        <text transform="matrix(1 0 0 1 45.4585 340.6353)" fill="#16100F" fontFamily="MyriadPro-Semibold" fontSize="12px">{user.goal.substring(fullgoal[6], fullgoal.length > 6 ? fullgoal[8] : <></>)}</text>
                        <text transform="matrix(1 0 0 1 45.4585 355.6353)" fill="#16100F" fontFamily="MyriadPro-Semibold" fontSize="12px">{user.goal.substring(fullgoal[8], fullgoal.length > 8 ? fullgoal[10] : <></>)}</text>
                        <text transform="matrix(1 0 0 1 45.4585 370.6353)" fill="#16100F" fontFamily="MyriadPro-Semibold" fontSize="12px">{user.goal.substring(fullgoal[10], fullgoal.length > 10 ? fullgoal[12] : <></>)}</text>
                        <text transform="matrix(1 0 0 1 45.4585 385.6353)" fill="#16100F" fontFamily="MyriadPro-Semibold" fontSize="12px">{user.goal.substring(fullgoal[12], fullgoal.length > 12 ? fullgoal[14] : <></>)}</text>
                        <text transform="matrix(1 0 0 1 45.4585 400.6353)" fill="#16100F" fontFamily="MyriadPro-Semibold" fontSize="12px">{user.goal.substring(fullgoal[14], fullgoal.length > 14 ? fullgoal[16] : <></>)}</text>
                        <text transform="matrix(1 0 0 1 45.4585 415.6353)" fill="#16100F" fontFamily="MyriadPro-Semibold" fontSize="12px">{user.goal.substring(fullgoal[16], fullgoal.length > 16 ? fullgoal[18] : <></>)}</text>
                        <text transform="matrix(1 0 0 1 45.4585 430.6353)" fill="#16100F" fontFamily="MyriadPro-Semibold" fontSize="12px">{user.goal.substring(fullgoal[18], fullgoal.length > 18 ? fullgoal[20] : <></>)}</text>
                        <text transform="matrix(1 0 0 1 45.4585 445.6353)" fill="#16100F" fontFamily="MyriadPro-Semibold" fontSize="12px">{user.goal.substring(fullgoal[20], fullgoal.length > 20 ? fullgoal[22] : <></>)}</text>
                        ...
                        <text transform="matrix(1 0 0 1 66.6108 594.7788)" fill="#25201D" fontFamily="MyriadPro-Semibold" fontSize="12px">{user.linkedln_link !== 'NOT_PRINT'?user.linkedln_link:<></>}</text>
