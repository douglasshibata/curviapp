    ...
    return (
        <>
            ...
            <div className="resumeBackground">
                ...
                <text transform="matrix(0.9856 0 0 1 260.2417 173.1533)" fontFamily="MyriadPro-Semibold" fill="#313131" fontWeight='bold' fontSize="12px">{user.companyName !== 'Primeiro emprego objetivando adquirir conhecimento e experiência necessária junto à empresa.' ? `Empresa:` :<></>}</text>
                <text transform="matrix(0.9856 0 0 1 260.2417 193.1533)" fontFamily="MyriadPro-Semibold" fill="#313131" fontSize="12px">{user.companyName !== 'Primeiro emprego objetivando adquirir conhecimento e experiência necessária junto à empresa.' ? `${user.companyName}` : user.companyName.substring(0, 38)}</text>
                <text transform="matrix(0.9856 0 0 1 260.2417 213.1533)" fontFamily="MyriadPro-Semibold" fill="#313131" fontSize="12px">{user.companyName !== 'Primeiro emprego objetivando adquirir conhecimento e experiência necessária junto à empresa.' ? `` : user.companyName.substring(38, 76)}</text>
                <text transform="matrix(0.9856 0 0 1 260.2417 233.1533)" fontFamily="MyriadPro-Semibold" fill="#313131" fontSize="12px">{user.companyName !== 'Primeiro emprego objetivando adquirir conhecimento e experiência necessária junto à empresa.' ? `` : user.companyName.substring(76, user.companyName.length)}</text>
