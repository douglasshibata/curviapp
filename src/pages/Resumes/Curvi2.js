            ...
            <div className="resumeBackground">
                <div className="resumeReady">
                    <svg id="curvi2" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 595.28 791.35">
                        ...
                        <text transform="matrix(1 0 0 1 70.3115 542.9448)" fontFamily='MyriadPro-Semibold' fill='#1B1119' fontSize='12'>{user.linkedln_link !== 'NOT_PRINT'? user.linkedln_link:<></>}</text>
                        ...
                        <text transform="matrix(1 0 0 1 35.3115 267.9448)" fontFamily='MyriadPro-Semibold' fill='#1B1119' fontSize='12px'>{user.goal.substring(0, fullgoal.length > 2 ? fullgoal[2] : <></>)}</text>
                        <text transform="matrix(1 0 0 1 35.3115 287.9448)" fontFamily='MyriadPro-Semibold' fill='#1B1119' fontSize='12px'>{user.goal.substring(fullgoal[2], fullgoal.length > 2 ? fullgoal[5] : <></>)}</text>
                        <text transform="matrix(1 0 0 1 35.3115 307.9448)" fontFamily='MyriadPro-Semibold' fill='#1B1119' fontSize='12px'>{user.goal.substring(fullgoal[5], fullgoal.length > 5 ? fullgoal[8] : <></>)}</text>
                        <text transform="matrix(1 0 0 1 35.3115 327.9448)" fontFamily='MyriadPro-Semibold' fill='#1B1119' fontSize='12px'>{user.goal.substring(fullgoal[8], fullgoal.length > 8 ? fullgoal[11] : <></>)}</text>
                        <text transform="matrix(1 0 0 1 35.3115 343.9448)" fontFamily='MyriadPro-Semibold' fill='#1B1119' fontSize='12px'>{user.goal.substring(fullgoal[11], fullgoal.length > 11 ? fullgoal[14] : <></>)}</text>
                        <text transform="matrix(1 0 0 1 35.3115 363.9448)" fontFamily='MyriadPro-Semibold' fill='#1B1119' fontSize='12px'>{user.goal.substring(fullgoal[14], fullgoal.length > 14 ? fullgoal[17] : <></>)}</text>
                        <text transform="matrix(1 0 0 1 35.3115 383.9448)" fontFamily='MyriadPro-Semibold' fill='#1B1119' fontSize='12px'>{user.goal.substring(fullgoal[17], fullgoal.length > 17 ? fullgoal[21] : <></>)}</text>
