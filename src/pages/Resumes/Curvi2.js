            ...
            <div className="resumeBackground">
                <div className="resumeReady">
                    <svg id="curvi2" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 595.28 791.35">
                        ...
                        <text transform="matrix(0.9856 0 0 1 229.5903 465.1074)" fontFamily="'MyriadPro-Semibold'" fill="#2C242D" fontSize="15.3958px">{user.companyName !== 'Primeiro emprego objetivando adquirir conhecimento e experiência necessária junto à empresa.'||user.companyName !== 'NOT_PRINT' ? `Empresa: ${user.companyName}` : user.companyName.substring(0, 38)}</text>
                        <text transform="matrix(0.9856 0 0 1 229.5903 485.1074)" fontFamily="'MyriadPro-Semibold'" fill="#2C242D" fontSize="15.3958px">{user.companyName !== 'Primeiro emprego objetivando adquirir conhecimento e experiência necessária junto à empresa.'||user.companyName !== 'NOT_PRINT' ? `` : user.companyName.substring(38, 75)}</text>
                        <text transform="matrix(0.9856 0 0 1 229.5903 495.1074)" fontFamily="'MyriadPro-Semibold'" fill="#2C242D" fontSize="15.3958px">{user.companyName !== 'Primeiro emprego objetivando adquirir conhecimento e experiência necessária junto à empresa.'||user.companyName !== 'NOT_PRINT' ? `` : user.companyName.substring(75, user.companyName.length)}</text>
                        ...
                        <text transform="matrix(1 0 0 1 33.3115 267.9448)" fontFamily='MyriadPro-Semibold' fill='#1B1119' fontSize='12px'>{user.goal.substring(0, fullgoal.length > 1 ? fullgoal[1] : <></>)}</text>
                        <text transform="matrix(1 0 0 1 33.3115 287.9448)" fontFamily='MyriadPro-Semibold' fill='#1B1119' fontSize='12px'>{user.goal.substring(fullgoal[1], fullgoal.length > 1 ? fullgoal[4] : <></>)}</text>
                        <text transform="matrix(1 0 0 1 33.3115 307.9448)" fontFamily='MyriadPro-Semibold' fill='#1B1119' fontSize='12px'>{user.goal.substring(fullgoal[4], fullgoal.length > 4 ? fullgoal[7] : <></>)}</text>
                        <text transform="matrix(1 0 0 1 33.3115 327.9448)" fontFamily='MyriadPro-Semibold' fill='#1B1119' fontSize='12px'>{user.goal.substring(fullgoal[7], fullgoal.length > 7 ? fullgoal[10] : <></>)}</text>
                        <text transform="matrix(1 0 0 1 33.3115 343.9448)" fontFamily='MyriadPro-Semibold' fill='#1B1119' fontSize='12px'>{user.goal.substring(fullgoal[10], fullgoal.length > 10 ? fullgoal[15] : <></>)}</text>
                        <text transform="matrix(1 0 0 1 33.3115 363.9448)" fontFamily='MyriadPro-Semibold' fill='#1B1119' fontSize='12px'>{user.goal.substring(fullgoal[15], fullgoal.length > 15 ? fullgoal[18] : <></>)}</text>
                        <text transform="matrix(1 0 0 1 33.3115 383.9448)" fontFamily='MyriadPro-Semibold' fill='#1B1119' fontSize='12px'>{user.goal.substring(fullgoal[18], fullgoal.length > 18 ? fullgoal[21] : <></>)}</text>
