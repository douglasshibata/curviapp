            ...
            <div className="resumeBackground">
                <div className="resumeReady">
                    <svg id="curvi8" data-name="Camada 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 537 841.89">
                        ...
                        <text transform="matrix(1 0 0 1 284.46 460.95)" fontFamily='MyriadPro-Semibold' fill='#1B1E1F' fontSize='14px'>{user.companyName !== 'Primeiro emprego objetivando adquirir conhecimento e experiência necessária junto à empresa.'||user.companyName !== 'NOT_PRINT'?`Empresa:`:user.companyName.substring(0,38)}</text>
                        <text transform="matrix(1 0 0 1 284.46 480.95)" fontFamily='MyriadPro-Semibold' fill='#1B1E1F' fontSize='14px'>{user.companyName !== 'Primeiro emprego objetivando adquirir conhecimento e experiência necessária junto à empresa.'||user.companyName !== 'NOT_PRINT'?`${user.companyName}`:<></>}</text>
                        <text transform="matrix(1 0 0 1 284.46 500.95)" fontFamily='MyriadPro-Semibold' fill='#1B1E1F' fontSize='14px'>{user.companyName !== 'Primeiro emprego objetivando adquirir conhecimento e experiência necessária junto à empresa.'||user.companyName !== 'NOT_PRINT'?``:user.companyName.substring(38,75)}</text>
                        <text transform="matrix(1 0 0 1 284.46 520.95)" fontFamily='MyriadPro-Semibold' fill='#1B1E1F' fontSize='14px'>{user.companyName !== 'Primeiro emprego objetivando adquirir conhecimento e experiência necessária junto à empresa.'||user.companyName !== 'NOT_PRINT'?``:user.companyName.substring(75,user.companyName.length)}</text>
