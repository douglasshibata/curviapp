            ...
            <div className="resumeBackground">
                <div className="resumeReady">
                    <svg id="curvi4" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 568.55 841.89">
                        ...
                        <text transform="matrix(1 0 0 1 240 310.4585)" fontFamily='MyriadPro-Semibold' fill='#666666' fontSize='14px'>{user.companyName !== 'Primeiro emprego objetivando adquirir conhecimento e experiência necessária junto à empresa.'?`Empresa: ${user.companyName}`:user.companyName.substring(0,38)}</text>
                        <text transform="matrix(1 0 0 1 240 330.4585)" fontFamily='MyriadPro-Semibold' fill='#666666' fontSize='14px'>{user.companyName !== 'Primeiro emprego objetivando adquirir conhecimento e experiência necessária junto à empresa.'?``:user.companyName.substring(38,75)}</text>
                        <text transform="matrix(1 0 0 1 240 350.4585)" fontFamily='MyriadPro-Semibold' fill='#666666' fontSize='14px'>{user.companyName !== 'Primeiro emprego objetivando adquirir conhecimento e experiência necessária junto à empresa.'?``:user.companyName.substring(75,user.companyName.length)}</text>
