            ...
            <div className="resumeBackground">
                <div className="resumeReady">
                    <svg id="curvi1" data-name="Camada 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 595.28 841.89">
                        ...
                        <text transform="matrix(1 0 0 1 200.2251 362.0723)" fill="#808285" fontFamily="'MyriadPro-Regular'" fontSize="12">{user.companyDescription !== "NOT_PRINT" ? user.companyDescription.substring(0,companyDescriptionArr.length>6?companyDescriptionArr[6]:<></>):<></>}</text>
