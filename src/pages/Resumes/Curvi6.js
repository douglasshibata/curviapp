                ...
                <div className="resumeReady">
                    <svg xmlns="http://www.w3.org/2000/svg" id='curvi6' viewBox="0 0 595.77 841.89">
                        ...
                        <g id="Layer_3" data-name="Layer 3">
                            ...
                            <text transform="matrix(0.9856 0 0 1 300.2417 443.1533)" fontFamily="MyriadPro-Semibold" fill="#120F10" fontSize="14px">{user.companyName !== 'Primeiro emprego objetivando adquirir conhecimento e experiência necessária junto à empresa.'||user.companyName !== 'NOT_PRINT' ? `Empresa: ${user.companyName}` : user.companyName.substring(0, 38)}</text>
                            <text transform="matrix(0.9856 0 0 1 300.2417 463.1533)" fontFamily="MyriadPro-Semibold" fill="#120F10" fontSize="14px">{user.companyName !== 'Primeiro emprego objetivando adquirir conhecimento e experiência necessária junto à empresa.'||user.companyName !== 'NOT_PRINT' ? `` : user.companyName.substring(38, 76)}</text>
                            <text transform="matrix(0.9856 0 0 1 300.2417 483.1533)" fontFamily="MyriadPro-Semibold" fill="#120F10" fontSize="14px">{user.companyName !== 'Primeiro emprego objetivando adquirir conhecimento e experiência necessária junto à empresa.'||user.companyName !== 'NOT_PRINT' ? `` : user.companyName.substring(76, user.companyName.length)}</text>
